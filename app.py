...
<html lang="ar" dir="rtl" class="h-full">
 ...
 <body class="h-full app-bg overflow-auto" style="width:100%;"><!-- WELCOME SCREEN -->
  ...
  function updateDate() {
    ...
    const gregEl = document.querySelector('[data-date="gregorian"]');
    ...
    try {
      ...
      const hijEl = document.querySelector('[data-date="hijri"]');
      if (hijEl) hijEl.textContent = hij;
    } catch(e) {
      const hijEl = document.querySelector('[data-date="hijri"]');
      if (hijEl) hijEl.textContent = '—';
    }
  }
  updateDate();
